 ...
 * @author Personal
 */
public class ListaServicio extends javax.swing.JDialog {

    /**
     * Creates new form ListaServicio
     */
    public ListaServicio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListaServicio dialog = new ListaServicio(new javax.swing.JFrame(), true);
